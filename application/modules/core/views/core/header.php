...
<head>
  ...
  <title>SMK 2 Piri Yogyakarta</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SMK 2 </b>PIRI</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li class="user user-menu">
            <a href="#">
              <span class="hidden-xs">Selamat Datang <b><?php echo $this->session->userdata('username');?></b></span>
            </a>
          </li>
        </ul>
      </div>
