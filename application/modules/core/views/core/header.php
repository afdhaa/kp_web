        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?php if($this->uri->segment(1)=="exceldown"){echo "active";} ?>">
                        <a href="<?php echo base_url('index.php/exceldown') ?>">
                            <i class="material-icons">class</i>
                            <span>Excel Download</span>
                        </a>
                    </li>
                    <li class="<?php if($this->uri->segment(1)=="isuexcelup"){echo "active";} ?>">
                        <a href="<?php echo base_url('index.php/isuexcelup') ?>">
                            <i class="material-icons">class</i>
